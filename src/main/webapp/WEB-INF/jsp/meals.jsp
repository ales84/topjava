    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                ...
                <td>${meal.calories}</td>
                <td><a href="meals?action=update&id=${meal.id}"><spring:message code="meals.updatemeal"/> </a></td>
                <td><a href="meals?action=delete&id=${meal.id}"><spring:message code="meals.deletemeal"/> </a></td>
            </tr>
        </c:forEach>
    </table>
</section>
