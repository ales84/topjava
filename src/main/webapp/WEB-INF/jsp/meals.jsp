...
<form class="form-horizontal" id="filter" method="post" action="/meals">
    <div class="form-group">
        ...
        <label for="endDate" class="control-label col-sm-4"><spring:message code="meals.endDate"/>:</label>
        <div class="col-sm-2">
    ...
    <div class="form-group">
        ...
        <label for="endTime" class="control-label col-sm-4"><spring:message code="meals.endTime"/>:</label>
        <div class="col-sm-2">
    ...
    <div class="panel-footer text-right">
        <a class="btn btn-danger" type="button" onclick="">
